...
const IMAGE_PROMPT_DESC: Record<ImageStyle, string> = {
  ...
  street:
    "A detailed PHOTOREALISTIC image prompt showing this city/place in this era as a STREET-LEVEL photograph. Shot at eye-level or slightly low angle, capturing the daily life of the city — people in period-accurate clothing, market stalls, vehicles/carts, shop fronts, street textures, and architectural facades lining the road. Include shallow depth of field (f/1.4-f/2.8) for cinematic bokeh. Show what makes THIS specific place's streets visually unique — not a generic scene. Include era-accurate architecture, signage, vegetation, lighting, and atmosphere. The image must look like a real photograph taken by a person standing in the street, NEVER an illustration.",
};
