...
const PREFIXES: Record<ImageStyle, string> = {
  aerial:
    "Generate a PHOTOREALISTIC aerial photograph with absolutely NO watermarks, NO text, NO logos, NO stock photo marks. NOT an illustration, NOT a painting, NOT a drawing. Ignore the art style of any reference images — use them only for geographic/architectural context. STRICT HISTORICAL ACCURACY — show ONLY architecture, infrastructure, and development that existed in the specified year, no anachronisms. Ultra-realistic wide establishing shot from elevated vantage point, DJI Mavic 3 drone, 24mm wide-angle lens, f/8, full cityscape and skyline, natural lighting, atmospheric perspective: ",
  street:
    "Generate a PHOTOREALISTIC street photograph with absolutely NO watermarks, NO text, NO logos, NO stock photo marks. NOT an illustration, NOT a painting, NOT a drawing. Ignore the art style of any reference images — use them only for geographic/architectural context. STRICT HISTORICAL ACCURACY — period-accurate clothing, architecture, street materials, vehicles, and goods for the exact year specified. Show a MODERATE number of people (5-12, not a huge crowd), mostly WALKING AWAY from camera with backs toward viewer, candid documentary style. Ultra-realistic eye-level shot, Canon EOS R5, 35mm lens, f/1.4, cinematic bokeh, natural lighting, film grain: ",
};
